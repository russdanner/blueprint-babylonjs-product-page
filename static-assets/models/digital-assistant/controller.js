var createSceneX = async function () {
    ...
    function initScene() {
        ...
        const env512 = BABYLON.CubeTexture.CreateFromPrefilteredData(modelPath+"studio_512.env", scene);
        env512.name = "studio";
        env512.gammaSpace = false;
        env512.rotationY = BABYLON.Tools.ToRadians(75);
    ...
    let loadTexturesAsync = async function() {
        ...
        staticTextures.morphShader = await BABYLON.NodeMaterial.ParseFromFileAsync("morphTexture", modelPath+"morphTextureShader.json", scene);
        staticTextures.morphTexture = staticTextures.morphShader.createProceduralTexture({ width: 2048, height: 1024 }, scene);

        return new Promise((resolve, reject) => {
            let textureUrls = [
                modelPath+"device_blackPlastic_basecolor.jpg",
                modelPath+"device_blackPlastic_orm.png",
                modelPath+"device_blackPlastic_normal.png",
                modelPath+"device_no_clearcoat.png",
                modelPath+"device_whiteplastic_basecolor.jpg",
                modelPath+"device_whiteplastic_orm.png",
                modelPath+"device_whiteplastic_normal.png",
                modelPath+"device_no_clearcoat.png",
                modelPath+"device_wood_basecolor.jpg",
                modelPath+"device_wood_orm.png",
                modelPath+"device_wood_normal.png",
                modelPath+"device_wood_clearcoat.png",
                modelPath+"device_light_emissive.png",
                modelPath+"device_tempScreenui_emissive.png",
                modelPath+"ui_battery_inactive.png",
                modelPath+"ui_calendar_active.png",
                modelPath+"ui_calendar_inactive.png",
                modelPath+"ui_contacts_active.png",
                modelPath+"ui_contacts_inactive.png",
                modelPath+"ui_music_active.png",
                modelPath+"ui_music_inactive.png",
                modelPath+"ui_next_inactive.png",
                modelPath+"ui_pause_inactive.png",
                modelPath+"ui_play_inactive.png",
                modelPath+"ui_previous_inactive.png",
                modelPath+"ui_wifi_inactive.png"
            ];
    ...
    async function loadMeshes() {
       // device.file = await BABYLON.SceneLoader.AppendAsync("assets/meshes/port_low.glb");
        ...
        //device.root.addRotation(0,-137,6378137)
    ...
    function initializeDevice() {
        ...
        devicePivot.rotation.x = BABYLON.Tools.ToRadians(159);
    ...
    function defineAnimations() {
        ...
        rootRotation1 = {
            ...
            keys: [
                {frame: 0, value: 0},
                {frame: 60, value: BABYLON.Tools.ToRadians(-430)} 
            ],
            easingFunction: new BABYLON.SineEase(),
            easingMode: BABYLON.EasingFunction.EASINGMODE_EASEINOUT,
            looping: false
...
var deviceCanvasX = async function() {
        var scene = await createSceneX(); //Call the createScene function
        var node = window.s.rootNodes[0];
